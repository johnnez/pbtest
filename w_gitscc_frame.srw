HA$PBExportHeader$w_gitscc_frame.srw
$PBExportComments$Generated MDI Frame
forward
global type w_gitscc_frame from window
end type
type mdi_1 from mdiclient within w_gitscc_frame
end type
end forward
...
string title = "Frame"
string menuname = "m_gitscc_frame"
...
global w_gitscc_frame w_gitscc_frame

type variables
n_gitscc_sheetmanager inv_sheetmgt
end variables

forward prototypes
public function long of_getsheetcount ()
public function integer of_sheetisclosing (readonly w_gitscc_basesheet aw_sheet)
...
string ls_sheets[]  = { "w_gitscc_sheet1", "w_gitscc_sheet2", "w_gitscc_sheet3" }
...
inv_sheetmgt = Create n_gitscc_sheetmanager

this.Post Event ue_postopen ( )
end event

on w_gitscc_frame.create
if this.MenuName = "m_gitscc_frame" then this.MenuID = create m_gitscc_frame
this.mdi_1=create mdi_1
this.Control[]={this.mdi_1}
end on

on w_gitscc_frame.destroy
