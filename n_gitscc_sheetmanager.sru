HA$PBExportHeader$n_gitscc_sheetmanager.sru
$PBExportComments$Generated MDI Sheet Management
forward
global type n_gitscc_sheetmanager from nonvisualobject
end type
end forward

global type n_gitscc_sheetmanager from nonvisualobject
end type
global n_gitscc_sheetmanager n_gitscc_sheetmanager

type variables
string is_sheets[], is_display[]
w_gitscc_basesheet iw_opensheets[]
menu im_items[]
end variables
...
public function long of_sheetisclosing (readonly w_gitscc_basesheet aw_sheet)
public function long of_classcount (readonly w_gitscc_basesheet aw_sheet)
public function integer of_openallsheets ()
public function integer of_adjustmenu (ref m_gitscc_frame am_menu)
...
//*-----------------------------------------------------------------*/
int li_rc
w_gitscc_basesheet lw_sheet

/*  Open an instance of the specified sheet  */
li_rc = OpenSheet ( lw_sheet, as_sheetname, w_gitscc_frame, 0, Cascaded! ) 
...
w_gitscc_basesheet lw_sheets[], lw_init[]
...
//*-----------------------------------------------------------------*/
m_gitscc_frame lm_menu
int li_i, li_max

lm_menu = w_gitscc_frame.MenuId
...
w_gitscc_sheet1	lw_sheet1
w_gitscc_sheet2	lw_sheet2
w_gitscc_sheet3	lw_sheet3
...
on n_gitscc_sheetmanager.create
call super::create
TriggerEvent( this, "constructor" )
end on

on n_gitscc_sheetmanager.destroy
